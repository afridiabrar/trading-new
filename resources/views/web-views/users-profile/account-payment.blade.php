            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="custom-control custom-radio mb-4">
                        ...
                        <label class="custom-control-label" for="paypal">PayPal<img class="d-inline-block align-middle ml-2" src="{{asset('assets/front-end')}}/img/card-paypal.png" width="39" alt="PayPal"></label>
                    </div>
                    <div class="custom-control custom-radio mb-4">
                        <input class="custom-control-input" type="radio" id="card" name="payment-method" checked>
                        <label class="custom-control-label" for="card">Credit / Debit card<img class="d-inline-block align-middle ml-2" src="{{asset('assets/front-end')}}/img/cards.png" width="187" alt="Credit card"></label>
                    </div>
                    <div class="row">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tr>
                            <td class="py-3 align-middle">
                                <div class="media align-items-center"><img class="mr-2" src="{{asset('assets/front-end')}}/img/card-visa.png" width="39" alt="Visa">
