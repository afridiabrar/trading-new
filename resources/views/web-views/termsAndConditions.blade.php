...
{{--        <h4 class="conditions">Last Updated: March 1, 2021 {!! $terms_and_conditions !!}</h4>--}}
    </div>
...
{{--                <h3>OVERVIEW</h3>--}}
{{--                <p>This website is operated by RCHIVE. Throughout the site, the terms “we”, “us” and “our” refer to--}}
{{--                    RCHIVE. RCHIVE offers this website, including all information, tools and services available from--}}
...
{{--                <p>Our store is hosted on WordPress. They provide us with an online e-commerce platform that allows us--}}
...
{{--                    or services may have limited quantities and are subject to exchange only according to our Return--}}
{{--                    Policy.</p>--}}
...
{{--                    descriptions of products or product pricing are subject to change at any time without notice, at the--}}
...
{{--                <p>For more detail, please review our Returns Policy available online:--}}
{{--                    www.rchive.ca/shipping-exchange</p>--}}
{{--            </div>--}}
{{--            <div class="col-sm-12 sec1">--}}
...
{{--                    our Privacy Policy: www.rchive.ca/privacy-policy.</p>--}}
{{--            </div>--}}
{{--            <div class="col-sm-12 sec1">--}}
...
{{--                    website, other websites, or the Internet.</p>--}}
{{--                <p>We reserve the right to terminate your use of the Service or any related website for violating any of--}}
...
{{--                <p>In no case shall RCHIVE, our directors, officers, employees, affiliates, agents, contractors,--}}
...
{{--                <p>You agree to indemnify, defend and hold harmless RCHIVE and our parent, subsidiaries, affiliates,--}}
...
{{--                    by and construed in accordance with the laws of the province of Ontario, Canada and applicable--}}
{{--                    federal laws of Canada, excluding any rules of private international law or the conflict of laws--}}
{{--                    that would lead to the application of the laws of any other jurisdiction and excluding any law that--}}
{{--                    implements the United Nations Convention on Contracts for the International Sale of Goods--}}
{{--                </p>--}}
{{--            </div>--}}
{{--            <div class="col-sm-12 sec1">--}}
...
{{--                    changes.</p>--}}
{{--            </div>--}}
{{--            <div class="col-sm-12 sec1 last">--}}
{{--                <h3>SECTION 20 – CONTACT INFORMATION</h3>--}}
{{--                <p>Questions about the Terms of Service should be sent to us at info@rchive.ca</p>--}}
                </div>
            </div>
        </div>
    </div>
