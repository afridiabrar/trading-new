                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                <label for="firstNameLabel"
                                       class="col-sm-3 col-form-label input-label">{{trans('messages.Full')}} {{trans('messages.name')}}
                                    <i
                                ...
                                <div class="col-sm-9 row">
                                    <div class="col-md-6">
                                        <label for="name">First {{trans('messages.Name')}} <span
                                    ...
                                    <div class="col-md-6">
                                        <label for="name">{{trans('messages.Last')}} {{trans('messages.Name')}} <span
                                                class="text-danger">*</span></label>
                            ...
                            <div class="row form-group">
                                <label for="phoneLabel"
                                       class="col-sm-3 col-form-label input-label">{{trans('messages.Phone')}} <span
                            ...
                            <div class="row form-group">
                                <label for="newEmailLabel"
                                       class="col-sm-3 col-form-label input-label">{{trans('messages.Email')}}</label>
                                ...
                                <div class="form-group col-md-9" id="select-img">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label"
                                               for="customFileUpload">{{trans('messages.image')}} {{trans('messages.Upload')}}</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Form Group -->
                            <div class="row form-group">
                                <label for="newPassword"
                                       class="col-sm-3 col-form-label input-label"> {{trans('messages.New')}}
                            ...
                            <div class="row form-group">
                                <label for="confirmNewPasswordLabel"
                                       class="col-sm-3 col-form-label input-label"> {{trans('messages.Confirm')}}
                                    {{trans('messages.password')}} </label>
