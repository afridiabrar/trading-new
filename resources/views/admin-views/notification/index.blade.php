    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{trans('messages.Notification')}}</li>
            </ol>
        </nav>
        <!-- End Page Header -->
                        ...
                        <form action="{{route('admin.notification.store')}}" method="post"
                            ...
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{trans('messages.Title')}} </label>
                                <input type="text" name="title" class="form-control" placeholder="New notification"
                                       required>
                            </div>
                            <div class="form-group">
                                <label class="input-label"
                            ...
                            <div class="form-group">
                                <label>{{trans('messages.Image')}} </label><small style="color: red"> ( Ratio 3:1
                                    )</small>
