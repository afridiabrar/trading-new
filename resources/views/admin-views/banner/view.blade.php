                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label for="name">{{trans('Banner Type')}}</label>
                                        <select
                                        ...
                                        <input type="text" name="title" max="100" class="form-control" id="title"
                                               required>
                                        <label for="name">Sub Title</label>
                                        <input type="text" name="sub_title" max="100" class="form-control"
                                               id="sub_title" required>
                                        <label class="control-label">Description</label>
                                        <textarea rows="10" type="text" id="description" name="description"
                                                  maxlength="65535" class="form-control" required></textarea>
