...
@section('content')
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption">
                        <div class="row">
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('sc-r.png') !!}">
                            </div><!-- end col-sm-6-->
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('p-2.png') !!}">
                            </div><!-- end col-sm-6-->
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('nike-1.png') !!}">
                            </div><!-- end col-sm-6-->
                        </div><!-- ROW col-sm-6 -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="row">
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('sc-e.png') !!}">
                            </div>
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('sc-f.png') !!}">
                            </div>
                            <div class="col-sm-4">
                                <img class="img-fluid" src="{!! frontImage('p-1.png') !!}">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid insta-feed hideit">
        <div class="row">
            <div class="col-md-2">
