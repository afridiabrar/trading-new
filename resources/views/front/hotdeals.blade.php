    ...
    <div class="container">
        ...
        <div class="Banner">
            <div class="banner-box">
                <figure><img src="img/micro.png" alt=""></figure>
            </div>
            <div class="contentDv">
                <div class="contentFlex">
                    <p>Lorem ipsum dolor sit amet</p>
                    <h2 class="fw-600 font-80 line-height-50">30 %<span class="font-40 fw-400">Off on</span></h2>
                    <h3 class="fw-600 font-80 line-height-50 subtitle">Microwave</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-4 pt-2">
                        <div class="card product">
                            <div class="card-body">
                                <div class="card-img-actions"> <img src="img/pr-1.jpg" class="card-img img-fluid"
                ...
                <div class="box py-4">
                    <img src="img/hotdeals.png" class="img-fluid" alt="" style="width:100%; height:342px;">
