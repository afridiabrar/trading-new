...
<section class="productpage">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="img-box">
                    <figure><img src="img/propage.png" alt=""></figure>
                </div>
                <div class="productsimages">
                    <ul class="images">
                        <li>
                            <figure><img src="img/signlepro.png" alt=""></figure>
                        </li>
                        <li>
                            <figure><img src="img/signlepro.png" alt=""></figure>
                        </li>
            ...
            <div class="col-md-6">
                ...
                <div class="offerHere">
                    <div class="TopBar">
                        <div class="property">
                            <h5 class="text-white">Buy 6 Smart TVs For Only</h5>
                        </div>
                        <div class="value">
                            <h5 class="text-white">Ends In</h5>
                        </div>
                    </div>
                    <div class="priceTime">
                        <div class="property">
                            <h3 class="text-white font-30 fw-700">$1200.55 <span class="font-15 fw-300">$1500.55</span>
                            </h3>
                        </div>
                        <div class="value">
                            <h5 class="text-white font-20 fw-400">21 : 45 :39</h5>
                        </div>
                    </div>
                </div>
                <div class="MOQ">
                    <h4 class="font-25 fw-500 py-4">Price Based On MOQ</h4>
                    <div class="moqtable">
                        <table>
                            <tr class="Rowone">
                                <td class="one">Quantity</td>
                                <td class="two">5-10</td>
                                <td class="three">11-15</td>
                                <td class="four">15-20</td>
                                <td class="five">20-25</td>
                                <td class="six">25-...</td>
                            </tr>
                            <tr class="Rowtwo">
                                ...
                                <td class="four">10%</td>
                                <td class="five">12%</td>
                                <td class="six">To be Negotiated</td>
                            </tr>
                        </table>
                    </div>
                </div>
                <div class="note">
                    <p>Note : To Avail this deal the minimum quantity is 4</p>
                </div>
                <div class="variations">
                    ...
                    <div class="quantity">
                        ...
                        <div class="colors">
                            <span class="colorselect" style="background:#000; height:35px; width:65px;"></span>
                            <div class="arrows">
                ...
                <div class="buttons">
                    <a class="cart" href="bookmark.php">Proceed To Checkout <i class="fa fa-shopping-basket"
        ...
        <div class="row">
            <div class="col-md-3 pt-2">
                <div class="card product">
                    <div class="card-body">
                        <div class="card-img-actions"> <img src="img/redled.png" class="card-img img-fluid" width="96"
                                height="350" alt=""> </div>
                    </div>
                    <hr class="p-0 m-0">
                    <div class="card-body">
