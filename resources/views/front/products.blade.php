    ...
    <div class="container">
        ...
        <div class="Banner">
            <div class="banner-box">
                <figure><img src="img/allproduct.png" alt=""></figure>
            </div>
            <div class="contentDv">
                <div class="contentFlex">
                    <p class="font-25">Get a Great Discount on</p>
                    <h3 class="fw-600 font-80 line-height-50 subtitle">All Products</h3>
            ...
            <div class="col-md-3">
                <div class="filters">
                    ...
                    <div class="ads-banner">
                        <figure><img src="img/ad2.png" alt=""></figure>
                    </div>
                </div>
            </div>
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-4 pt-2">
                        <div class="card product">
                            <div class="card-body">
                                <div class="card-img-actions"> <img src="img/tv1.png" class="card-img img-fluid"
                    ...
                    <div class="col-md-4 pt-2">
                        <div class="card product">
                            <div class="card-body">
                                <span class="notify-badge">20 % off</span>
                                <div class="card-img-actions"> <img src="img/tv2.png" class="card-img img-fluid"
                                        width="96" height="350" alt=""> </div>
                            </div>
                            <hr class="p-0 m-0">
                            <div class="card-body">
                    ...
                    <div class="col-md-4 pt-2">
                        <div class="card product">
                            <div class="card-body">
                                <span class="notify-badge">20 % off</span>
                                <div class="card-img-actions"> <img src="img/tv3.png" class="card-img img-fluid"
                                        width="96" height="350" alt=""> </div>
                            </div>
                            <hr class="p-0 m-0">
                            <div class="card-body">
                ...
                <div class="box py-4">
                    <img src="img/allproducts.png" class="img-fluid" alt="" style="width:100%; height:342px;">
                    ...
                    <div class="m-centered">
                        ...
                        <h2 class="text-black line-height-1 font-35">Kitchen Product</h2>
                    </div>
                </div>
                ...
                <div class="pagination">
                    <div class="pafination-Flex">
                        <ul class="items">
                            <li class="pagi arrow prev-arrow"><a href="#!"><i class="fa fa-angle-left"
                                        aria-hidden="true"></i></a></li>
                            <li class="pagi"><a href="#!">1</a></li>
                            <li class="pagi active"><a href="#!">2</a></li>
                            <li class="pagi"><a href="#!">...</a></li>
                            <li class="pagi"><a href="#!">12</a></li>
                            <li class="pagi arrow next-arrow"><a href="#!"><i class="fa fa-angle-right"
                                        aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
