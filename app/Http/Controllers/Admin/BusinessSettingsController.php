...
class BusinessSettingsController extends Controller
{
    ...
    {
        $pull = BusinessSetting::where('type', 'refund_policy')->first();
    ...
    public function pull_update(Request $data)
    {
        ...
        $checkFirst = BusinessSetting::where('type', 'refund_policy')->first();

        if ($checkFirst) {
            BusinessSetting::where('type', 'refund_policy')->update(['value' => $data->value]);
        } else {
            BusinessSetting::insert(
                [
                    'type' => 'refund_policy',
    ...
    {
        $shipping_and_exchange = BusinessSetting::where('type', 'cookie_policy')->first();
    ...
    public function shipping_and_exchange_update(Request $data)
    {
        ...
        $checkFirst = BusinessSetting::where('type', 'cookie_policy')->first();

        if ($checkFirst) {
            BusinessSetting::where('type', 'cookie_policy')->update(['value' => $data->value]);
        } else {
            BusinessSetting::insert(
                [
                    'type' => 'cookie_policy',
        ...
        Toastr::success('Cookie Policy updated successfully!');
        return redirect()->back();
    }
