...
//        });
        ...
        Route::group(['prefix' => 'ads', 'as' => 'ads.'], function () {
            Route::get('add-new', 'AdsController@index')->name('add-new');;
            Route::post('add-new', 'AdsController@store')->name('store');
            Route::get('update', 'AdsController@edit')->name('update');;
            Route::post('update/{id}', 'AdsController@update')->name('edit');
            Route::post('status', 'AdsController@status')->name('status');
            Route::get('delete', 'AdsController@delete')->name('delete');
...
//            });
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order']], function () {
            ...
            Route::post('tracking/status', 'OrderController@tracking_status')->name('tracking.status');
...
//            Route::post('contact-store', 'ContactController@store')->name('store');
    ...
    Route::get('/image','ProductController@importProducts');
    Route::get('/importLeftProducts','ProductController@importLeftProducts');
