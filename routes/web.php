...
// Route::get('laravel-send-email', 'EmailController@sendEMail')->name('laravel-send-email');

// Route::get('laravel-send-email', function () {
//     $user = [
//         'name' => 'Harsukh Makwana',
//         'info' => 'Laravel & Python Devloper'
//     ];

//     Mail::to('developer197855@gmail.com')->send(new \App\Mail\MyTestMail($user));
//     dd("success");
// });
...
Route::get('/checkFaildedJobs', function () {
    $row = \Illuminate\Support\Facades\DB::table('failed_jobs')->get();
?>
    <?php foreach ($row as $value) {  ?>
        <p><?= json_decode($value->payload, true)['data']['command'] ?></p>
