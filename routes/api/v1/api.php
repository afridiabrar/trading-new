...
Route::group(['namespace' => 'api\v1', 'prefix' => 'v1', 'middleware' => ['api_lang']], function () {
    ...
    Route::group(['prefix' => 'auth', 'namespace' => 'auth'], function () {
        ...
        Route::post('reset-password', 'ForgotPassword@reset_password_submit');
    });

    //    Route::group(['prefix' => ''], function () {
        Route::get('/config', 'ConfigController@configuration');
    //    });

    Route::post('/newsletter', 'GeneralController@newsletter');
    Route::post('/contactUs', 'GeneralController@contactUs');
    Route::get('/social-media/links', 'GeneralController@socialMediaLinks');
    Route::get('/company-information', 'GeneralController@webConfig');
    Route::get('/blogs', 'GeneralController@blogs');
    Route::get('/blog/{id}', 'GeneralController@blog');
    ...
    Route::get('faq', 'GeneralController@faq');
        ...
        Route::get('trading', 'ProductController@get_trading_products');
        Route::get('search', 'ProductController@get_searched_products');
        Route::get('search/price', 'ProductController@searchByPriceRange');
        Route::get('details/{id}', 'ProductController@get_product');
        Route::get('hot-deals', 'ProductController@get_hot_deals');
    ...
    Route::group(['prefix' => 'categories'], function () {
        ...
        Route::get('products/hot-deals/{category_id}', 'CategoryController@get_hot_deals_products');
        Route::get('products/trading/{category_id}', 'CategoryController@get_trading_products');
    });

    Route::get('track/{tracking_id}', 'OrderController@tracking_order');
    Route::get('ads', 'GeneralController@getAds');
    Route::get('country', 'GeneralController@getCountries');
    Route::get('top-products','GeneralController@topproducts');
    Route::get('get_pages','GeneralController@get_pages');


    Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
        Route::get('info', 'CustomerController@info');
        Route::post('update-profile', 'CustomerController@update_profile');
        Route::post('change_password','auth\PassportAuthController@change_password');
        ...
        Route::group(['prefix' => 'wish-list'], function () {
            ...
            Route::delete('remove_all', 'CustomerController@remove_all_wishlist');
        });
